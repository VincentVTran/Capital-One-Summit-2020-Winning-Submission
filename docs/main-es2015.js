...
class DataService {
    ...
    getClues(category, value, min_date, max_date) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var param2 = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
            if (value != null) {
            ...
            return this.http.get(this.baseURL + "/api/clues", { params: param2 });
        });
    }
    getCategories() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return this.http.get(this.baseURL + "/api/categories", { params: params });
        });
    }
};
...
let ResultComponent = class ResultComponent {
    ...
    filter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.min != null && this.max != null) {
                this.minParam = yield this.formatDate(this.min);
                //console.log(this.minParam);
                this.maxParam = yield this.formatDate(this.max);
                //console.log(this.maxParam);
            }
            if (this.min != null && this.max == null) {
                this.maxParam = yield this.formatDate(this.min);
                this.minParam = null;
            }
            if (this.min == null && this.max != null) {
                this.minParam = yield this.formatDate(this.max);
                this.maxParam = null;
            }
            let extractedData = yield this.dataService.getClues(this.route.snapshot.params['categoryID'], this.pointsSelected, this.minParam, this.maxParam);
            extractedData.subscribe((data) => {
    ...
    getData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.loading = true;
            let extractedData = yield this.dataService.getClues(this.route.snapshot.params['categoryID'], this.pointsSelected, this.min, this.max);
            extractedData.subscribe((data) => {
                this.resultData = data;
                this.removeDateFormat();
                this.loading = false;
    ...
    formatDate(date) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            //console.log(date);
            var month = (yield date.getMonth()) + 1;
            if (month < 10) {
            ...
            var day = yield date.getDate().toString();
            if (day < 10) {
                day = "0" + day.toString();
            }
            else {
            ...
            var year = (yield date.getFullYear().toString());
...
let StartComponent = class StartComponent {
    ...
    getCategories() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let extractedData = yield this.dataService.getCategories();
            extractedData.subscribe((data) => {
